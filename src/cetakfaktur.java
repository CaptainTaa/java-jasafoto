...
("jdbc:mysql://127.0.0.1/jasafoto", "root", "");
...
+"'";
 ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
              jTextArea1.setText("                           *** FAKTUR JASA FOTO ***"+
                                 "\n            Jl.Bhayangkara nomor 55 - 57 Tipes Surakarta"+
                                 "\n                                      Telp.(021)8901348"+
                                 "\n================================================="+
                                 "\n=================TRANSAKSI FOTO=================" + "\n" 
                                      ...
                                      + "Kode Jasa                               : " + rs.getString(4)+ "\n"
                                      + "Jasa Foto                                 : " + rs.getString(5)+ "\n"
                                      + "Harga                                       : " + rs.getString(6) +"\n"
                                      + "Keterang                                  : " + rs.getString(7) +"\n"
                                      +
                                
                                 "\n================================================="+
                                 "\n    Terimasih Telah Menggunakan Jasa Foto Dari Kami,"+
